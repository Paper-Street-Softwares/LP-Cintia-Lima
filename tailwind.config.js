...
export const theme = {
  extend: {
    colors: {
      ...
      minititle: "#F3D89A", //bg minitag de seções escuras
      ...
      iconButtons: "#000000",
      labelButtons: "#000000",
      minititleLightLabel: "#000000", //label das minitag de seções claras
      minititleDarkLabel: "#000000", //label minitag de seções escuras
